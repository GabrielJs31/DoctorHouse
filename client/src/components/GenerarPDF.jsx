...
const GenerarPDF = ({ data }) => {
  const crearPDF = () => {
    try {
      ...
      log.info("pdf_generate_start", { keys });
      ...
      agregarSeccion(
        ...
        `Descripción: ${
          ...
          data.enfermedad_actual?.tratamiento || "-"
        }\nExámenes: ${
          data.enfermedad_actual?.examenes_requeridos || "-"
        }\nDerivación: ${
          data.enfermedad_actual?.derivacion_especialista || "-"
      ...
      agregarSeccion(
        ...
        `Personales: ${data.antecedentes?.personales || "-"}\nAlergias: ${
          ...
          data.antecedentes?.intervenciones_quirúrgicas || "-"
        }\nCoagulación: ${
          data.antecedentes?.problemas_coagulación || "-"
        }\nAnestésicos: ${
          data.antecedentes?.problemas_anestésicos || "-"
        }\nCardiovasculares: ${
          data.antecedentes?.problemas_cardiovasculares || "-"
        }\nFuma: ${data.antecedentes?.fuma || "-"}\nAlcohol: ${
          data.antecedentes?.alcohol || "-"
        }`
      );
      ...
      agregarSeccion(
        ...
        `FR: ${data.signos_vitales?.frecuencia_respiratoria || "-"}\nFC: ${
          data.signos_vitales?.frecuencia_cardíaca || "-"
        }\nPA: ${data.signos_vitales?.presión_arterial || "-"}\nSat O₂: ${
          data.signos_vitales?.saturación_oxígeno || "-"
